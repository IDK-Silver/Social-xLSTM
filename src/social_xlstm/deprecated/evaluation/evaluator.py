"""
DEPRECATED MODULE: This module is deprecated and will be removed in future versions.

RECOMMENDED ALTERNATIVES:
- For basic metrics recording: Use `social_xlstm.metrics.writer.TrainingMetricsWriter`
...
import warnings
warnings.warn(
    "The 'evaluator' module is deprecated. Use 'social_xlstm.metrics' for new implementations.",
    DeprecationWarning,
    stacklevel=2
)
